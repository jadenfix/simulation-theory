...
from .causal import minimum_selection_gamma, minimum_unrestricted_intervention_rate, raw_probability_bounds_from_selected, selected_binary_probability
from .inference import evidence_ceiling, optimal_equal_prior_accuracy, robust_posterior_interval
from .lazy_rendering import approximate_memory_bits_lower_bound, approximate_state_packing_lower_bound, conditional_tv_profile, sequential_total_variation_bound, transcript_total_variation
from .minimax import fano_iid_error_lower_bound, necessary_iid_samples_for_error
from .observer_measure import descendant_resource_bound, model_averaged_simulated_fraction, plug_in_simulated_fraction
from .physics import bekenstein_information_bits, landauer_erasure_energy, mass_limited_operation_rate, schwarzschild_radius_meters
from .sequential import exact_anytime_mixture_rejection_probability, exact_expected_mixture_e_value
...
def main() -> None:
    ...
    laws = {("a",): [1.0, 0.0, 0.0], ("b",): [0.0, 1.0, 0.0], ("c",): [0.0, 0.0, 1.0], ("near-a",): [0.95, 0.05, 0.0]}
    ...
    print("P_null_cross_by_50", exact_anytime_mixture_rejection_probability(50, 0.1, 0.1, alternatives, 0.05, weights))
